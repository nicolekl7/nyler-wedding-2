...
const EventRsvpButton = ({ eventKey, value, isSelected, onSelect }: Props) => {
  ...
  return (
    <motion.button
      ...
      style={{ minHeight: 48 }}
      animate={{
        backgroundColor: isSelected ? (isAccept ? OLIVE : "transparent") : "transparent",
        borderColor: isSelected ? OLIVE : "hsl(63 30% 75%)",
        color: isSelected && isAccept ? CREAM : isSelected ? OLIVE : "hsl(63 42% 35%)",
      }}
