...
const RSVP = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    // Check for previous RSVP in invited_guests
  ...
  const handleSubmit = async () => {
    ...
    formData.append("Room Preference", "");
    ...
    try {
      ...
      // Also save to invited_guests for future lookups
      await supabase
        .from("invited_guests")
        .update({
    ...
    return (
      <Layout>
        <section className="page-section w-[90%] max-w-[700px] mx-auto text-center">
          <FadeIn>
            <h1 className="heading-section mb-4">RSVP</h1>
  ...
  return (
    <Layout>
      ...
      <section className="page-section w-[90%] max-w-[700px] mx-auto">
        <FadeIn>
          <h1 className="heading-section text-center mb-4">RSVP</h1>
        ...
        {guest && (
          <FadeIn delay={100}>
            <div className="space-y-12">
              ...
              <div>
                <label className="heading-sub block mb-2">Additional Notes (Optional)</label>
                <textarea
                  value={notes}
